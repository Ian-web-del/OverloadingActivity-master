public class App{
    ...
    public static void main(String[] args) throws Exception {
         ...
         */
        System.out.println("The greater value between 79 and 86 is " + greaterValue(79,86));

        /**
         * Call the greaterValue method with double parameters
         */
        System.out.println("The greater value between 5.2 and 7.6 is " + greaterValue(5.2,7.6));
